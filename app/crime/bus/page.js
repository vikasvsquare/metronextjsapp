          ...
          <aside className="relative hidden lg:block lg:basis-3/12 pl-6 pt-6 bg-gradient-to-b from-[#050708] from-[-2.29%] to-[#0089E3] to-[90.57%] min-h-screen rounded-tr-3xl">
            <div>
              ...
              <ul className="my-4">
                ...
                <li>
                  <button className="bg-transparent text-white text-center font-medium rounded-l-2xl py-3 px-4 mr-4 w-full">G Line</button>
                </li>
                <li>
                  <button className="bg-transparent text-white text-center font-medium rounded-l-2xl py-3 px-4 mr-4 w-full">J Line</button>
                </li>
                <li>
                  <button className="bg-transparent text-white text-center font-medium rounded-l-2xl py-3 px-4 mr-4 w-full">Line 2</button>
                </li>
                <li>
                  <button className="bg-transparent text-white text-center font-medium rounded-l-2xl py-3 px-4 mr-4 w-full">Line 4</button>
                </li>
                <li>
                  <button className="bg-transparent text-white text-center font-medium rounded-l-2xl py-3 px-4 mr-4 w-full">Line 10</button>
                </li>
                <li>
                  <button className="bg-transparent text-white text-center font-medium rounded-l-2xl py-3 px-4 mr-4 w-full">Line 11</button>
                </li>
              </ul>
            </div>
          </aside>

        ...
        <main className="lg:grow lg:basis-9/12 mt-14">
          ...
          <div id="content" className="relative z-10 bg-sky-100 p-7 lg:py-8 lg:px-16 mt-10 rounded-2xl">
            ...
            <div className="bg-white py-4 px-4 text-sm lg:text-base text-slate-400 rounded-lg mt-6">
              <h3 style={{ fontSize: '8.77px', fontWeight: 700, lineHeight: '20px', textAlign: 'left', borderBottom: '1px solid #0089E3', width: '121px', marginBottom: '1rem' }}>UNDER PERSON CRIME</h3>
              <div className="flex flex-col gap-5">
                <p className='-mb-4' style={{ fontSize: '9.62px' }}>Agg Assault on Operator</p>
                <div className="flex w-full h-4 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-200">
                  <div className="flex flex-col justify-center rounded-full overflow-hidden bg-[#0065A8;] text-xs text-white text-center whitespace-nowrap dark:bg-[#0065A8;] transition duration-500"
                    style={{ width: '50%' }}>50%</div>
                </div>
                <p className='-mb-4' style={{ fontSize: '9.62px' }}>Agg Assault on Operator</p>
                <div className="flex w-full h-4 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-200">
                  <div className="flex flex-col justify-center rounded-full overflow-hidden bg-[#0490EB] text-xs text-white text-center whitespace-nowrap dark:bg-[#0490EB] transition duration-500"
                    style={{ width: '25%' }}>25%</div>
                </div>
                <p className='-mb-4' style={{ fontSize: '9.62px' }}>Agg Assault on Operator</p>
                <div className="flex w-full h-4 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-200">
                  <div className="flex flex-col justify-center rounded-full overflow-hidden bg-[#57B7F5] text-xs text-white text-center whitespace-nowrap dark:bg-[#57B7F5] transition duration-500"
                    style={{ width: '20%' }}>20%</div>
                </div>
                <p className='-mb-4' style={{ fontSize: '9.62px' }}>Agg Assault on Operator</p>
                <div className="flex w-full h-4 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-200">
                  <div className="flex flex-col justify-center rounded-full overflow-hidden bg-[#A9DCFD] text-xs text-white text-center whitespace-nowrap dark:bg-[#A9DCFD] transition duration-500"

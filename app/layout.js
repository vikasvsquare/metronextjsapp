          ...
          <div className="flex items-center justify-between gap-x-6">
            ...
            <div className="basis-10/12 flex items-center lg:gap-x-12 py-6 lg:p-6 border-0 border-lg-l border-lg-b border-solid border-[#0099ff] rounded-bl-3xl">
              ...
              <div className="hidden lg:flex items-center basis-3/12 lg:basis-6/12 p-2 gap-2 bg-slate-100 rounded-lg">
                <Link href="/crime/rail" className="flex-auto bg-white rounded-lg px-4 py-2 bg-gradient-to-r from-[#0189E1] from-[4.1%] to-[#014B7B] to-[87.17%] text-white flex items-center">
                ...
                <Link href="/crime/bus" className="flex-auto bg-white rounded-lg px-4 py-2 flex items-center">
                  <span className="inline-block max-w-9 h-5 mr-4">
                    <Image
                      className="object-contain"
                      alt="bus"
                ...
                <Link href="/crime/system-wide" className="flex-auto bg-white rounded-lg px-4 py-2 flex items-center">
                  <span className="inline-block max-w-9 h-5 mr-4">
                    <Image
                      className="object-contain"
                      alt="system wide"

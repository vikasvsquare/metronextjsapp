          ...
          <section class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="space-y-6">
              <div>
                ...
                <div class="space-y-4">
                  <div>
                    <h4 class="font-semibold text-gray-600 !text-lg">Homicide</h4>
                    <p class="text-gray-600">
                      Murder and nonnegligent manslaughter: the willful (nonnegligent) killing of one human being by another.
                    </p>
                  </div>
                  <div>
                    <h4 class="font-semibold text-gray-600 !text-lg">Rape</h4>
                    <p class="text-gray-600">
                  ...
                  <div>
                    <h4 class="font-semibold text-gray-600 !text-lg">Robbery</h4>
                    <p class="text-gray-600">
                  ...
                  <div>
                    <h4 class="font-semibold text-gray-600 !text-lg">Aggravated Assault</h4>
                    <p class="text-gray-600">
                  ...
                  <div>
                    <h4 class="font-semibold text-gray-600 !text-lg">Aggravated Assault on an Operator</h4>
                    <p class="text-gray-600">
                  ...
                  <div>
                    <h4 class="font-semibold text-gray-600 !text-lg">Battery</h4>
                    <p class="text-gray-600">
                  ...
                  <div>
                    <h4 class="font-semibold text-gray-600 !text-lg">Battery on an Operator</h4>
                    <p class="text-gray-600">
                      Simple assaults, not aggravated, includes all assaults which do not involve the use of a firearm, knife, cutting
                  ...
                  <div>
                    <h4 class="font-semibold text-gray-600 !text-lg">Sex Offenses</h4>
              ...
              <div>
                ...
                <div class="space-y-4">
                  <div>
                    <h4 class="font-semibold text-gray-600 !text-lg">Arson</h4>
                    <p class="text-gray-600">
                  ...
                  <div>
                    <h4 class="font-semibold text-gray-600 !text-lg">Bike Theft</h4>
                    <p class="text-gray-600">Theft of a bicycle.</p>
                  </div>
                  <div>
                    <h4 class="font-semibold text-gray-600 !text-lg">Burglary</h4>
                    <p class="text-gray-600">The unlawful entry of a structure to commit a felony or a theft.</p>
                  </div>
                  <div>
                    <h4 class="font-semibold text-gray-600 !text-lg">Larceny</h4>
                    <p class="text-gray-600">
                  ...
                  <div>
                    <h4 class="font-semibold text-gray-600 !text-lg">Motor Vehicle Theft</h4>
                    <p class="text-gray-600">The theft or attempted theft of a motor vehicle.</p>
                  </div>
                  <div>
                    <h4 class="font-semibold text-gray-600 !text-lg">Vandalism</h4>
                    <p class="text-gray-600">
              ...
              <div>
                ...
                <div class="space-y-4">
                  <div>
                    <h4 class="font-semibold text-gray-600 !text-lg">Narcotics</h4>
                    <p class="text-gray-600">Arrest due to possession of a narcotic substance.</p>
                  </div>
                  <div>
                    <h4 class="font-semibold text-gray-600 !text-lg">Trespassing</h4>
                    <p class="text-gray-600">Arrest due to entering premises without permission (e.g., without paying fare).</p>
                  </div>
                  <div>
                    <h4 class="font-semibold text-gray-600 !text-lg">Weapons</h4>

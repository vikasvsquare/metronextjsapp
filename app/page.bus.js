                  ...
                  <div className="relative z-10 md:flex md:items-center bg-black pt-6 px-7 pb-7 lg:pt-9 lg:px-9 lg:pb-10 mt-20 rounded-6xl rounded-tl-none">
                    <div className="md:basis-1/2 md:px-5 md:even:border-l md:even:border-solid md:even:border-white">
                      <ul className="flex flex-wrap items-center justify-between">
                        <li className="inline-flex items-center justify-between mt-2.5">
                          <h3 className="text-2xl text-yellow-300 font-semibold">277</h3>
                    ...
                    <div className="md:basis-1/2 md:px-5 md:even:border-l md:even:border-solid md:even:border-white">
                      <ul className="flex flex-wrap items-center justify-between">
                        <li className="inline-flex items-center justify-between mt-2.5">
                          <div>
                            <h3 className="text-2xl text-yellow-300 font-semibold">314</h3>
                        ...
                        <li className="inline-flex items-center justify-between mt-2.5">
                          <div>
                            <h3 className="text-2xl text-yellow-300 font-semibold">271</h3>
                            <div className="flex flex-wrap items-center justify-around">
                ...
                <div className="relative">
                  ...
                  <div className="relative z-10 md:flex md:items-center bg-black pt-6 px-7 pb-7 lg:pt-9 lg:px-9 lg:pb-10 mt-20 rounded-6xl rounded-tl-none">
                    <div className="md:basis-1/2 md:px-5 md:even:border-l md:even:border-solid md:even:border-white">
                      <ul className="flex flex-wrap items-center justify-between">
                        <li className="inline-flex items-center justify-between mt-2.5">
                          <h3 className="text-2xl text-yellow-300 font-semibold">20M</h3>
                          <h6 className="text-sm text-white font-semibold ml-5">Boardings</h6>
                        </li>
                        <li className="inline-flex items-center justify-between mt-2.5">
                          <h3 className="text-2xl text-yellow-300 font-semibold">0.36</h3>
                    ...
                    <div className="md:basis-1/2 md:px-5 md:even:border-l md:even:border-solid md:even:border-white">
                      <ul className="flex flex-wrap items-center justify-between">
                        <li className="inline-flex items-center justify-between mt-2.5">
                          <div>
                            <h3 className="text-2xl text-yellow-300 font-semibold">90</h3>
                          </div>
                          <h6 className="text-sm text-white font-semibold ml-5">Current Month</h6>
                        </li>
                        <li className="inline-flex items-center justify-between mt-2.5">
                          <div>
                            <h3 className="text-2xl text-yellow-300 font-semibold">97</h3>
                            <div className="flex flex-wrap items-center justify-around">
                              <span className="text-sm text-lime-400">(-7%)</span>
                              <svg width="8" height="11" viewBox="0 0 8 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                  d="M4.5 1C4.5 0.723858 4.27614 0.5 4 0.5C3.72386 0.5 3.5 0.723858 3.5 1H4.5ZM3.64645 10.3536C3.84171 10.5488 4.15829 10.5488 4.35355 10.3536L7.53553 7.17157C7.7308 6.97631 7.7308 6.65973 7.53553 6.46447C7.34027 6.2692 7.02369 6.2692 6.82843 6.46447L4 9.29289L1.17157 6.46447C0.976311 6.2692 0.659728 6.2692 0.464466 6.46447C0.269204 6.65973 0.269204 6.97631 0.464466 7.17157L3.64645 10.3536ZM3.5 1L3.5 10H4.5L4.5 1H3.5Z"
                                  fill="#3ACE00"
                        ...
                        <li className="inline-flex items-center justify-between mt-2.5">
                          <div>
                            <h3 className="text-2xl text-yellow-300 font-semibold">78</h3>
                            <div className="flex flex-wrap items-center justify-around">
                ...
                <div className="relative">
                  ...
                  <div className="relative z-10 md:flex md:items-center bg-black pt-6 px-7 pb-7 lg:pt-9 lg:px-9 lg:pb-10 mt-20 rounded-6xl rounded-tl-none">
                    <div className="md:basis-1/2 md:px-5 md:even:border-l md:even:border-solid md:even:border-white">
                      <ul className="flex flex-wrap items-center justify-between">
                        <li className="inline-flex items-center justify-between mt-2.5">
                          <h3 className="text-2xl text-yellow-300 font-semibold">81</h3>
                    ...
                    <div className="md:basis-1/2 md:px-5 md:even:border-l md:even:border-solid md:even:border-white">
                      <ul className="flex flex-wrap items-center justify-between">
                        <li className="inline-flex items-center justify-between mt-2.5">
                          <div>
                            <h3 className="text-2xl text-yellow-300 font-semibold">84</h3>
                            <div className="flex flex-wrap items-center justify-around">
                              <span className="text-sm text-lime-600">(-4%)</span>
                              <svg width="8" height="11" viewBox="0 0 8 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                  d="M4.5 1C4.5 0.723858 4.27614 0.5 4 0.5C3.72386 0.5 3.5 0.723858 3.5 1H4.5ZM3.64645 10.3536C3.84171 10.5488 4.15829 10.5488 4.35355 10.3536L7.53553 7.17157C7.7308 6.97631 7.7308 6.65973 7.53553 6.46447C7.34027 6.2692 7.02369 6.2692 6.82843 6.46447L4 9.29289L1.17157 6.46447C0.976311 6.2692 0.659728 6.2692 0.464466 6.46447C0.269204 6.65973 0.269204 6.97631 0.464466 7.17157L3.64645 10.3536ZM3.5 1L3.5 10H4.5L4.5 1H3.5Z"
                                  fill="#3ACE00"
                        ...
                        <li className="inline-flex items-center justify-between mt-2.5">
                          <div>
                            <h3 className="text-2xl text-yellow-300 font-semibold">111</h3>
                            <div className="flex flex-wrap items-center justify-around">
                              <span className="text-sm text-lime-400">(-27%)</span>
                              <svg width="8" height="11" viewBox="0 0 8 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                  d="M4.5 1C4.5 0.723858 4.27614 0.5 4 0.5C3.72386 0.5 3.5 0.723858 3.5 1H4.5ZM3.64645 10.3536C3.84171 10.5488 4.15829 10.5488 4.35355 10.3536L7.53553 7.17157C7.7308 6.97631 7.7308 6.65973 7.53553 6.46447C7.34027 6.2692 7.02369 6.2692 6.82843 6.46447L4 9.29289L1.17157 6.46447C0.976311 6.2692 0.659728 6.2692 0.464466 6.46447C0.269204 6.65973 0.269204 6.97631 0.464466 7.17157L3.64645 10.3536ZM3.5 1L3.5 10H4.5L4.5 1H3.5Z"
                                  fill="#3ACE00"

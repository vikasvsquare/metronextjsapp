        ...
        <div className="flex items-center justify-between gap-x-6 py-5">
          ...
          <div className="hidden lg:flex items-center basis-3/12 lg:basis-6/12 p-2 gap-2 bg-slate-100 rounded-6xl">
            <Link
              href="/"
              className={
                'flex-auto rounded-6xl px-4 py-2 flex items-center hover:no-underline ' +
                (pathName === '/' ? 'text-white bg-black' : 'bg-white')
              }
            >
                ...
                <span className="inline-block max-w-9 h-5 mr-4">
                  <svg width="16" height="25" viewBox="0 0 16 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      fill={`${pathName === '/' ? 'white' : '#8E8E8E'}`}
                    />
                    <ellipse cx="6.78568" cy="0.888897" rx="0.900909" ry="0.888897" fill={`${pathName === '/' ? 'white' : '#8E8E8E'}`} />
                    <ellipse cx="3.39243" cy="15.3966" rx="0.962012" ry="0.949185" fill={`${pathName === '/' ? 'black' : 'white'}`} />
                    <ellipse cx="12.4839" cy="15.3966" rx="0.962012" ry="0.949185" fill={`${pathName === '/' ? 'black' : 'white'}`} />
                    <path
                      ...
                      fill={`${pathName === '/' ? 'white' : '#8E8E8E'}`}
                    />
                    <ellipse cx="9.0361" cy="0.888897" rx="0.900909" ry="0.888897" fill={`${pathName === '/' ? 'white' : '#8E8E8E'}`} />
                    <path
            ...
            <Link
              ...
              className={
                'flex-auto rounded-6xl px-4 py-2 flex items-center hover:no-underline ' +
                (pathName === '/bus' ? 'text-white bg-black' : 'bg-white')
              }
            >
              <span className="inline-block max-w-9 h-5 mr-4">
                <svg width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    fill={`${pathName === '/bus' ? 'white' : '#8E8E8E'}`}
                  />
                  <path
                  ...
                  <rect
                    ...
                    fill={`${pathName === '/bus' ? 'black' : 'white'}`}
                  />
                  <ellipse cx="4.04544" cy="12.8017" rx="0.874118" ry="0.851705" fill={`${pathName === '/bus' ? 'black' : 'white'}`} />
                  <ellipse cx="14.6975" cy="12.8017" rx="0.874118" ry="0.851705" fill={`${pathName === '/bus' ? 'black' : 'white'}`} />
                </svg>
              </span>
              <span>Bus</span>
            </Link>
            <Link
              ...
              className={
                'flex-auto rounded-6xl px-4 py-2 flex items-center hover:no-underline ' +
                (pathName === '/system-wide' ? 'text-white bg-black' : 'bg-white')
              }
            >
              <span className="inline-block max-w-9 h-5 mr-4">
                <svg width="35" height="26" viewBox="0 0 35 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    fill={`${pathName === '/system-wide' ? 'white' : '#8E8E8E'}`}
                  />
                  <path
                    ...
                    fill={`${pathName === '/system-wide' ? 'black' : 'white'}`}
                  />
                  <path
                      ...
                      <span className="inline-block max-w-9 h-5 mr-4">
                        <svg width="16" height="25" viewBox="0 0 16 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <ellipse
                            ...
                            fill={`${pathName === '/' ? 'blackish' : 'white'}`}
                          />
                          <ellipse cx="3.39243" cy="15.3966" rx="0.962012" ry="0.949185" fill={`${pathName === '/' ? 'black' : 'black'}`} />
                          <ellipse cx="12.4839" cy="15.3966" rx="0.962012" ry="0.949185" fill={`${pathName === '/' ? 'black' : 'black'}`} />
                          <path
                            d="M3.57809 21.2997H2.28413L0 24.2365H1.33897L2.16036 23.2576H13.6598L14.3461 24.2365H15.9214L13.6598 21.2997H12.3208L13.1872 22.3012H2.7342L3.57809 21.2997Z"
                            fill={`${pathName === '/' ? 'blackish' : 'white'}`}
                          />
                    ...
                    <Link href="/system-wide" className="flex-auto px-8 py-4 flex items-center">
                      <span className="inline-block max-w-9 h-5 mr-4">
                        <svg width="35" height="26" viewBox="0 0 35 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <path
                            d="M26.5086 21.8599C23.7397 21.8747 19.4847 20.8907 19.4847 20.8907V21.7399C19.4847 21.7399 23.7392 22.709 26.5086 22.7182C29.1683 22.7271 33.2648 21.8599 33.2648 21.8599V20.8907C33.2648 20.8907 29.174 21.8456 26.5086 21.8599Z"
                            fill={`${pathName === '/system-wide' ? 'white' : 'black'}`}
                          />
                          <path
                            d="M32.5634 11.2825H20.3708V16.3128C20.7358 17.0649 21.0314 17.2733 21.6722 17.3742H31.3451C32.1048 17.156 32.345 16.9052 32.5634 16.3128V11.2825Z"
                            fill={`${pathName === '/system-wide' ? 'white' : 'black'}`}

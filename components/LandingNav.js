              ...
              <span className="inline-block max-w-9 h-5 mr-4">
                <svg width="35" height="26" viewBox="0 0 35 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path
                    ...
                    fill={`${pathName === '/system-wide' ? 'black' : 'white'}`}
                  />
                  <rect x="23.5736" y="9.18732" width="5.66709" height="0.922979" rx="0.461489" fill={`${pathName === '/system-wide' ? 'black' : 'white'}`} />
                  <ellipse cx="21.6168" cy="19.3752" rx="0.793762" ry="0.773409" fill={`${pathName === '/system-wide' ? 'black' : 'white'}`} />
                  <ellipse cx="31.2896" cy="19.3752" rx="0.793762" ry="0.773409" fill={`${pathName === '/system-wide' ? 'black' : 'white'}`} />
                  <path
                    ...
                    fill={`${pathName === '/system-wide' ? 'white' : '#8E8E8E'}`}
                  />
                  <ellipse cx="6.49841" cy="0.851291" rx="0.862794" ry="0.851291" fill={`${pathName === '/system-wide' ? 'white' : '#8E8E8E'}`} />
                  <ellipse cx="3.24883" cy="14.7452" rx="0.921312" ry="0.909027" fill={`${pathName === '/system-wide' ? 'black' : 'white'}`} />
                  <ellipse cx="11.9557" cy="14.7452" rx="0.921312" ry="0.909027" fill={`${pathName === '/system-wide' ? 'black' : 'white'}`} />
                  <path
                    ...
                    fill={`${pathName === '/system-wide' ? 'white' : '#8E8E8E'}`}
                  />
                  <ellipse cx="8.65357" cy="0.851291" rx="0.862794" ry="0.851291" fill={`${pathName === '/system-wide' ? 'white' : '#8E8E8E'}`} />
                  <path
                  ...
                  <path
                    ...
                    fill={`${pathName === '/system-wide' ? 'black' : 'white'}`}
                  />
                  <rect x="5.02136" y="3.75006" width="5.1293" height="0.862066" rx="0.431033" fill={`${pathName === '/system-wide' ? 'black' : 'white'}`} />
                </svg>
              </span>

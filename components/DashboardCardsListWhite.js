...
function DashboardCardsListWhite({ label, labelValue, dateValue, percentage, upDown }) {
  ...
  return (
    <>
      <div class="metro__crime-card text-white p-2">
        <div class="card-body d-flex flex-column justify-content-between h-100">

          {/* <!-- Top Section: Title & Date --> */}
          <div class="card-wrapper">
            <div class="align-items-center d-flex justify-content-between w-100">
              <div class="m-0 metro__card-title-date">
                {label}
              </div>
              <div
                class="d-inline-flex align-items-center p-1 rounded-2 metro__txt-blue metro__card-date">
                <span class="mb-0 text-spanrimary">{dateValue}</span>
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16"
                  ...
                  <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    stroke="#2A54A7" strokeWidth="1.5" stroke-linecap="round"
                    stroke-linejoin="round" />
                </svg>
              </div>
            </div>
            <div class="text-lg-start w-100">
              <p class="m-0 metro__card-title-number" s>
                {labelValue}
              </p>
            </div>
          </div>
          ...
          <div class="align-items-center d-flex  w-100 d-flex items-center gap-0">
            {upDown? (
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                <rect y="0.5" width="18" height="18" rx="2" fill="#D9EFFF" />
                <path d="M5.46446 12.4919L5.46446 5.96474L11.9916 5.96474M5.91773 6.41802L12.5355 13.0358" stroke="#2A54A7" strokeWidth="1.53846" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            ) : (
              <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
                <rect y="0.5" width="18.5888" height="18" rx="2" fill="#D9EFFF" />
                <path d="M12.2879 12.7611L5.78559 13.33L5.21671 6.82769M6.19763 12.8389L12.2135 5.66955" stroke="#2A54A7" strokeWidth="1.53846" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            )}
            <p class="m-0 metro__txt-small metro__txt-blue">

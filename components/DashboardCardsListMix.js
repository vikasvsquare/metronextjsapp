...
function DashboardCardsListMix({label, labelValue, dateValue}) {
  ...
  return (
    <>
      <div class="metro__crime-card metro__mix text-white p-2">
            <div class="card-body d-flex flex-column justify-content-between h-100">
              ...
              <div class="card-wrapper">
                <div class="align-items-center d-flex justify-content-between w-100">
                  ...
                  <div
                    class="d-inline-flex align-items-center p-1 rounded-2 metro__txt-blue metro__card-date-mix">
              ...
              <div class="align-items-start d-flex mt-2 w-100"></div>
